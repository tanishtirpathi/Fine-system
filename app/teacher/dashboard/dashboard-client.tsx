          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-[var(--muted)]">
                ...
                Manage student fines by department and semester. All records are stored on the college portal.
        ...
        <CollegePanel className="p-4 sm:p-6">
          ...
          <div className="flex flex-col gap-4 border-b border-[var(--border)] pb-5 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-[var(--muted)]">Filter by roll no., department, or payment status.</p>
